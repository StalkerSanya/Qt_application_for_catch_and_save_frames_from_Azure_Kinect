...
class CameraRGBD(QThread):
    ...
    def save_frames(self):
        ...
        cv2.imwrite(self.output_dir + "/depth/raw/" + unique_image_name + ".png", self.depth_raw)
        cv2.imwrite(self.output_dir + "/depth/mean_30/" + unique_image_name + ".png", self.depth_mean)
